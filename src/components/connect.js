        ...
        <div className="container">
            ...
            <div className="row justify-content-center align-items-center">
                <div className="col-4 col-md">
                    ...
                    <svg aria-hidden="true" width="2em" focusable="false" data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div className="col-4 col-md">
                    ...
                    <svg aria-hidden="true" focusable="false" width="2em" data-prefix="fab" data-icon="instagram" class="svg-inline--fa fa-instagram fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="col-4 col-md">
                    ...
                    <svg aria-hidden="true" focusable="false" width="2em" data-prefix="fab" data-icon="twitter" class="svg-inline--fa fa-twitter fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div className="col-4 col-md">
                    ...
                    <svg aria-hidden="true" focusable="false" width="2em" data-prefix="fab" data-icon="linkedin" class="svg-inline--fa fa-linkedin fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="col-4 col-md">
                    ...
                    <svg aria-hidden="true" focusable="false" width="2em" data-prefix="fab" data-icon="pinterest" class="svg-inline--fa fa-pinterest fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
